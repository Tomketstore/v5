...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m              VILLAIN TUNNELING PROJECT              \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo ""
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Tomketstore/v5/main/"
start=$(date +%s)
secs_to_human() {
...
<b>Install Script Ft by TOMKET STORE</b>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/ohmyvillain"},{"text":"Contack","url":"wa.me/6281927625651"}]]}'
...
wget "http://raw.githubusercontent.com/Tomketstore/v5/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e "\e[95;1m  Telegram : t.me/ohmyvillain \e[0m"
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
...
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e " TERIMAKASIH SUDAH MENGGUNAKAN LAYANAN AUTO SCRIPT PREMIUM"
echo -e " VILLAIN TUNNELING ATAU TOMKET STORE"
echo -e " -SEMOGA BERMANFAAT BAGI SEMUA ORANG-"
echo -e " ADIOS"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo ""
