...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/ohmyvillain"},{"text":"Contack","url":"wa.me/6287863789967"}]]}'
...
cd /bin
git clone  https://github.com/Tomketstore/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
